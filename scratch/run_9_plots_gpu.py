...
def run_9_plots(village_name):
    print(f"\n{'='*60}")
    print(f"Running 9 plots for {village_name} on GPU")
    print(f"{'='*60}")
    ...
    # Configure and run
    # workers=1 is required on Windows to avoid multiprocessing deadlocks with PyTorch
    ...
    # Rename predictions.geojson to gpupred.geojson
